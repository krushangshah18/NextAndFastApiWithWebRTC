...
TICK_RATE    = 10   # Hz
MAX_SESSIONS = 3    # safe limit for local CPU — analysis: 1 user = 29.7% CPU / 1245 MB RSS,
                    # 3 users ≈ 76% CPU / 1580 MB RSS (287 MB headroom), 4+ causes OOM/freeze
